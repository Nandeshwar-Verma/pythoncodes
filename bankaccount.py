...
class Account():
    ...
    def deposit(self,depositVal):
        print("amount added to account initiated")
    ...
    def withdrawal(self,withdrawVal):
        print("amount withdrawal initiated")
        if withdrawVal > self.balance:
            ...
            print("amount withdrawn {0:10.2f} and remaining balance {1:10.2f}".format(withdrawVal,self.balance))
